...
import com.codebind.FrontEnd.MainWindow;
...
public class UpdateDisplay implements Runnable{
    ...
    public UpdateDisplay(MainWindow MainWindow, ChatSystem app, JScrollPane Scroll, JTextPane textPane, JTextField textField, JList<String> listSession, DefaultListModel<String> model, JLabel CurrentSession, DefaultListModel<String> modelUserconnected, JList<String> listUserConnected){
